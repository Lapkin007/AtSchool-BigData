...
object InsertIntoMySQL
{
  def insert(array:Array[String]): Unit = {
    ...
    movieDF.write.mode("append").jdbc("jdbc:mysql://localhost:3306/movierecommend?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=UTC&allowPublicKeyRetrieval=true", "movierecommend.recommendresult", prop)
    movieDF.show()
  }
}
//InsertintoMySQL